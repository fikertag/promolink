...
const features = [
  {
    ...
    content: "Companies create profiles and set rates for their products.",
  ...
  },
  {
    ...
    content: "Find influencers that align with your brand and audience.",
  ...
  },
  {
    ...
    title: "Promote & Track",
    content:
      "Promote products on social media and track performance in real-time.",
        ...
        <div className="relative mx-auto mb-12 max-w-2xl sm:text-center">
          <div className="relative z-10">
            <h2 className="font-geist text-3xl font-bold tracking-tighter md:text-4xl lg:text-5xl">
              Boost Your Sales with MyKalat
            </h2>
            <p className="font-geist text-foreground/60 mt-3">
              Connect businesses with influencers to drive authentic product
            </p>
          </div>
          <div
